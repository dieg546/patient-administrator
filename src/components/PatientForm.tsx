...
export default function PatientForm() {
    ...
    const {addPatient,editingId,getEditingId} = usePatientStore()
    ...
    useEffect(()=>{
        ...
        if(editingId){
            ...
            const {name,caretaker,email,date,symptoms} = getEditingId(editingId)[0]
            setValue('name',name)
        ...
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            >
                <div className="mb-5">
                    ...
                    <input  
                        ...
                        {...register('name',{ 
                            ...
                            maxLength: {value: 8, message:'El maximo de caracteres es de 8'}
                            })
                        }
                    />
                    {errors.name &&(
                ...
                <div className="mb-5">
                    ...
                    {errors.date && <Error>{errors.email?.message?.toString()}</Error>}
